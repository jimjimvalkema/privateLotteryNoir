...
function hashNullifier(nullifierPreimage) {
    return ethers.toBeHex(poseidon1([nullifierPreimage]))
}
...
const inputs = {
    ...
    //public inputs
    root: "0x1747bb05aaf32015b99495ddb14dca8661b7b1454f5e02eaa8e06769a4a9cc9c",
    nullifier: hashNullifier("0x02"),
    pickId: "0x03",
    recipient: "0x04",
}
